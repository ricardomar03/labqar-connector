...
app.conf.update(
    BROKER_URL='amqp://ijgtqkvn:RR3B2rRF-YQXBevJMxweXez-m61TBT_f@hare.rmq.cloudamqp.com/ijgtqkvn',
...
@app.task
def inserir_canal(can_id, uni_id, par_id, can_num_estacao, can_num_unidade, can_unidade_medida, can_conv_med_mul, can_conv_med_add, can_min_medida, can_max_medida, can_min_alarme, can_max_alarme, can_validacao, can_suspenso, can_background, can_coeficiente, can_num_monit, ual_meteo, ual_sin_cmd, ual_slope, ual_y0, ual_nome, sam_ganho, sam_sin_alarme, sam_sin_zero, sam_sin_max, sam_cmd_zero, sam_cmd_max, vir_formula, uar_tipo, uar_calculo, uar_num_entrada, can_reg_eventos, can_addr_eventos, can_acumula_eventos):
    return
...
@app.task
def inserir_dados(dad_id, est_id, cam_id, dad_data, dad_1med, dad_1stat, dad_2med, dad_2stat, dad_3med, dad_3stat, dad_4med, dad_4stat, dad_5med, dad_5stat, dad_6med, dad_6stat, dad_7med, dad_7stat, dad_8med, dad_8stat, dad_9med, dad_9stat, dad_10med, dad_10stat, dad_11med, dad_11stat, dad_12med, dad_12stat, dad_13med, dad_13stat, dad_14med, dad_14stat, dad_15med, dad_15stat, dad_16med, dad_16stat, dad_17med, dad_17stat, dad_18med, dad_18stat, dad_19med, dad_19stat,dad_20med, dad_20stat, dad_p_aquisicao):
    return
...
@app.task
def inserir_estacao(est_id, map_id, red_id, est_nome, est_abreviatura, est_codigo, est_instituicao, est_pos_x, est_pos_y, est_local, est_data_instal, est_tipo_ligacao, est_telefone, est_central_telef, est_indicativo, est_ultima_revisao, est_foto, est_obs, est_alarme_a, est_tel_alarme_a, est_alarme_b, est_tel_alarme_b, est_alarme_c, est_tel_alarme_c, est_num_tent, est_atraso_tent, est_p_aq_normal, est_p_aq_alarme, est_perc_validacao, est_num_canais_activ, est_mascara, est_data_validacao, est_comunicacao, est_modem_init, est_modem_dial, est_template, est_relogio_sinc, est_autonomia, est_meteo_est_id, est_meteo_vel_id, est_meteo_dir_id, est_meteo_used, est_auto_validacao, cam_id, est_porta_serie, est_tipo, est_activa, est_data_ult_act):
    return

@app.task
def inserir_estado(est_id, est_data, est_1med, est_1mode, est_1valido, est_1alarme, est_2med, est_2mode, est_2valido, est_2alarme, est_3med, est_3mode, est_3valido, est_3alarme, est_4med, est_4mode, est_4valido, est_4alarme, est_5med, est_5mode, est_5valido, est_5alarme, est_6med, est_6mode, est_6valido, est_6alarme, est_7med, est_7mode, est_7valido, est_7alarme, est_8med, est_8mode, est_8valido, est_8alarme, est_9med, est_9mode, est_9valido, est_9alarme, est_10med, est_10mode, est_10valido, est_10alarme, est_11med, est_11mode, est_11valido, est_11alarme, est_12med, est_12mode, est_12valido, est_12alarme, est_13med, est_13mode, est_13valido, est_13alarme, est_14med, est_14mode, est_14valido, est_14alarme, est_15med, est_15mode, est_15valido, est_15alarme, est_16med, est_16mode, est_16valido, est_16alarme, est_17med, est_17mode, est_17valido, est_17alarme, est_18med, est_18mode, est_18valido, est_18alarme, est_19med, est_19mode, est_19valido, est_19alarme, est_20med, est_20mode, est_20valido, est_20alarme):
    return

@app.task
def inserir_estado_interno(uni_id, est_data, est_1nome, est1_unidmed, est_1valor, est_1modo, est_1valido, est_2nome, est_2unidmed, est_2valor, est_2modo, est_2valido, est_3nome, est_3unidmed, est_3valor, est_3modo, est_3valido, est_4nome, est_4unidmed, est_4valor, est_4modo, est_4valido, est_5nome, est_5unidmed, est_5valor, est_5modo, est_5valido, est_6nome, est_6unidmed, est_6valor, est_6modo, est_6valido, est_7nome, est_7unidmed, est_7valor, est_7modo, est_7valido, est_8nome, est_8unidmed, est_8valor, est_8modo, est_8valido, est_9nome, est_9unidmed, est_9valor, est_9modo, est_9valido, est_10nome, est_10unidmed, est_10valor, est_10modo, est_10valido, est_11nome, est_11unidmed, est_11valor, est_11modo, est_11valido, est_12nome, est_12unidmed, est_12valor, est_12modo, est_12valido, est_13nome, est_13unidmed, est_13valor, est_13modo, est_13valido, est_14nome, est_14unidmed, est_14valor, est_14modo, est_14valido, est_15nome, est_15unidmed, est_15valor, est_15modo, est_15valido, est_16nome, est_16unidmed, est_16valor, est_16modo, est_16valido):
    return
...
@app.task
def inserir_unidade(uni_id, est_id, uni_tipo, uni_num_serie, uni_nome, uni_ual_lres, uni_ual_hres, uni_dt_programa, uni_ual_prodid, uni_ual_majver, uni_ual_minver, uni_ual_revver, uni_sam_calib_zero, uni_sam_calib_max, uni_sam_sinc_calibh, uni_sam_sinc_calibm, uni_sam_ciclo_calib, uni_asm_endereco, uni_asm_offset, uni_asm_gama, uni_asm_tempo_resp, uni_asm_unidade, uni_asm_calib_zero_ref, uni_asm_calib_zero, uni_asm_calib_auto, uni_asm_calib_max, uni_asm_dur_zero, uni_asm_dur_max, uni_asm_span, uni_asm_banco, uni_versao, uni_modelo, uni_suspenso, uni_dt_recolha, uni_tea_tavrg, uni_tea_ctemp, uni_tea_cpres, uni_asm_modo, uni_ccr_nloca_amostra, uni_ccr_nloca_total, uni_dtl_password, uni_obs_intervalo_s, uni_obs_intervalo_p, uni_obs_intervalo_q, uni_obs_bateria, uni_obs_cartridge, uni_obs_apaga_dados, uni_ccr_nloca_eventos, uni_ccr_nloca_total_eventos):
    return